...
-- Généré le :  Mar 16 Avril 2019 à 11:25
...
--
-- Contenu de la table `artiste_band`
--
...
--
-- Contenu de la table `movie_studio`
--
...
--
-- Contenu de la table `song_artiste`
--
...
--
-- Contenu de la table `soundtrack`
--
...
--
-- Contenu de la table `soundtrack_song`
--
...
--
-- Index pour la table `artiste_band`
--
ALTER TABLE `artiste_band`
  ADD PRIMARY KEY (`artiste_bandID`),
  ADD KEY `artiste_band_fk_artiste` (`a_artisteID`),
  ADD KEY `artiste_band_fk_band` (`b_bandID`);
...
ALTER TABLE `movie_genre`
  ADD PRIMARY KEY (`movie_genreID`),
  ADD KEY `movie_genre_fk_movie` (`m_movieID`),
  ADD KEY `movie_genre_fk_genre` (`g_genreID`);

--
-- Index pour la table `movie_studio`
--
ALTER TABLE `movie_studio`
  ADD PRIMARY KEY (`movie_studioID`),
  ADD KEY `movie_studio_fk_movie` (`m_movieID`),
  ADD KEY `movie_studio_fk_studio` (`s_studioID`);
...
ALTER TABLE `poster`
  ...
  ADD KEY `poster_fk_movie` (`p_movieID`);
...
ALTER TABLE `role`
  ...
  ADD KEY `role_fk_movie` (`m_movieID`),
  ADD KEY `role_fk_person` (`p_personID`);
...
--
-- Index pour la table `song_artiste`
--
ALTER TABLE `song_artiste`
  ADD PRIMARY KEY (`song_artisteID`),
  ADD KEY `song_artiste_fk_song` (`s_songID`),
  ADD KEY `song_artiste_fk_artiste` (`a_artisteID`);

--
-- Index pour la table `song_band`
--
ALTER TABLE `song_band`
  ADD PRIMARY KEY (`song_bandID`),
  ADD KEY `song_band_fk_song` (`song_songID`),
  ADD KEY `song_band_fk_band` (`b_bandID`);

--
-- Index pour la table `soundtrack`
--
ALTER TABLE `soundtrack`
  ADD PRIMARY KEY (`soundtrackID`),
  ADD KEY `soundtrack_fk_movie` (`m_movieID`);

--
-- Index pour la table `soundtrack_song`
--
ALTER TABLE `soundtrack_song`
  ADD PRIMARY KEY (`soundtrack_songID`),
  ADD KEY `soundtrack_song_fk_soundtrack` (`soundtrack_soundtrackID`),
  ADD KEY `soundtrack_song_fk_song` (`song_songID`);
...
--
-- Index pour la table `trailer`
--
ALTER TABLE `trailer`
  ADD PRIMARY KEY (`trailerID`),
  ADD KEY `trailer_fk_movie` (`t_movieID`);
